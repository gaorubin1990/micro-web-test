...
var hijackers_1 = require("./hijackers");
...
function genSandbox(appName) {
    ...
    var sandbox = new Proxy(window, {
        ...
        get: function (target, p) {
             ...
             */
            if (lodash_1.isFunction(value) && !utils_1.isConstructable(value)) {
        ...
        mount: function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    ...
                    freers.push.apply(freers, tslib_1.__spread(hijackers_1.hijack()));
                    /* ------------------------------------------ 3. 重置一些初始化时的副作用 ------------------------------------------*/
